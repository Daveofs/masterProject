...
SHELL=/capstor/scratch/cscs/damrein/cosmogridv1_test2/cosmo_000001/run_0/shells_nside=2048_corrected.npz
# Configuration for the visualization (set to your desired z-bin and nside)
VMIN=-1.0
VMAX=1.0
ZBIN=5
NSIDE=2048
NAME_SUFFIX="disco_corrected_nside=${NSIDE}_zbin=${ZBIN}"
