...
def save_class_transfer_function(k, tf, filename='transfer_function.txt'):
    """
    Save transfer function in CLASS format
    """
    header = "k (h/Mpc)    -T_tot/k2"
...
ax2.semilogx(k_hMpc, ratio, color="mediumpurple", lw=1.5)
...
save_class_transfer_function(k, tf, os.path.join(PARAM_DIR,'transfer_fiducial.dat'))
