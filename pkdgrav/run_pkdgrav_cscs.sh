...
OUTPUT_DIR=/capstor/scratch/cscs/damrein/cosmogridv1_test2/cosmo_000001/run_0
PARAM_FILE=/capstor/scratch/cscs/damrein/cosmogridv1_test2/cosmo_000001/run_0/cosmology.par
...
# Fast IC generation with mpi enabled and more nodes, also ensure that bParaWrite = 1 (parallel write)
