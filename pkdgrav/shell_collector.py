...
def process_single(args):
    n_step, namespace, z_out, z_output, npix = args
    current_pixels = []
    current_proc = 0
    while True:
...
if __name__ == "__main__":
    ...
    task_args = [(n_step, namespace, z_out, z_output, npix) for n_step in range(1, steps + 1)]
    multi_collect = [pool.apply_async(process_single, args=(a,)) for a in task_args]
