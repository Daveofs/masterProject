...
# Usage:
#   bash run_visualize_shell_local.sh
# Optional overrides:
...
INPUT_FILE_DEFAULT="${REPO_ROOT}/compressed_shells.npz"
...
ZBIN="${ZBIN:-5}"
NSIDE="${NSIDE:-2048}"
NAME_SUFFIX="${NAME_SUFFIX:-compressed_shells_nside=${NSIDE}_zbin${ZBIN}_nside${NSIDE}}"
