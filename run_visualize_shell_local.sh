...
INPUT_FILE_DEFAULT="/Users/david/testData/cosmo_000001/shells_nside=512_noisy_shuffle.npz"
...
ZBIN="${ZBIN:-5}"
NSIDE="${NSIDE:-512}"
NAME_SUFFIX="${NAME_SUFFIX:-shells_noisy_shuffle_nside=${NSIDE}_zbin${ZBIN}_nside${NSIDE}}"
